...
var phpGetNewPrice = 'php/php-get-new-price.php',
    phpGetCities = 'php/php-get-cities.php';
...
function CartPushcase() {
    ...
    this.profileSettingsSubmit = function() {
    ...
    this.setPhoneMask = function() {
        ...
        $(function() {
            ...
            $('.cart-pushcase__input_phone').mask("+380 99 999 99 99", {completed:function(){
                $(this).addClass('cart-pushcase__input_complete');
            }});

            $('.cart-pushcase__input_year').mask("9999");
            $('.cart-pushcase__input_month').mask("99");
            $('.cart-pushcase__input_day').mask("99");
