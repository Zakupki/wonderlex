<form action="/admin/updatehowtobuy/" method="post">

  <div class="h1">
    <h1><?=$this->view->translate['howtobuy'];?></h1>
        ...
        <div class="multiling">
          <div class="multiling-select">
            <select>
              <?
                $cnt=0;
                foreach($this->view->howtobuy as $lang) {
              ?>
          ...
          <?
            ...
            foreach($this->view->howtobuy as $lang) {
          ?>
              <div class="multiling-item<?=($cnt)?'':' multiling-current';?>"><textarea name="content[<?=$lang['languageid'];?>]" rows="" cols=""><?=$lang['howtobuy'];?></textarea></div>
          <?
              $cnt++;
            }
          ?>
