														...
														<div class="row">
															...
															<div class="inputs">
																<ul class="inline">
																	...
																	<li><input class="radio" name="send" value="2" type="radio" /> владельцам сайтов</li>
																	<li><input class="radio" name="send" value="3" type="radio" /> только обычным пользователям</li>
																</ul>
