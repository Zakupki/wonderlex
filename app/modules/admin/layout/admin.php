			...
			<div id="menus_wrapper">
				<div id="main_menu">
					<ul>
						...
						<?}if($this->view->registry->controller=='sites'){?>
							<li><a href="/admin/sites/" class="selected"><span><span>Сайты</span></span></a></li>
						<?}else{?>
							<li><a href="/admin/sites/"><span><span>Сайты</span></span></a></li>
						<?}if($this->view->registry->controller=='citation'){?>
							<li><a href="/admin/citations/" class="selected"><span><span>Цытаты</span></span></a></li>
						<?}else{?>
							<li><a href="/admin/citations/"><span><span>Цытаты</span></span></a></li>
						<?}if($this->view->registry->controller=='mail'){?>
							<li><a href="/admin/mail/" class="selected"><span><span>Рассылки</span></span></a></li>
						<?}else{?>
							<li><a href="/admin/mail/"><span><span>Рассылки</span></span></a></li>
						<?}if($this->view->registry->controller=='arttype'){?>
                            <li><a href="/admin/arttype/" class="selected"><span><span>Категории товаров</span></span></a></li>
                        <?}else{?>
                            <li><a href="/admin/arttype/"><span><span>Категории товаров</span></span></a></li>
                        <?}?>
                        <?if($this->view->registry->controller=='orders'){?>
                            <li><a href="/admin/orders/" class="selected"><span><span>Заказы</span></span></a></li>
                        <?}else{?>
                            <li><a href="/admin/orders/"><span><span>Заказы</span></span></a></li>
                        <?}?>
				...
				<div id="sec_menu">
						<ul>
						<? if($this->view->registry->controller=='arttype'){?>
						<li><a href="/admin/arttype/" class="sm4">Вид искусств</a></li>
						<li><a href="/admin/arttype/styles/" class="sm4">Стили и направления в искусстве</a></li>
						<li><a href="/admin/arttype/genres/" class="sm4">Жанры</a></li>
						<?} if($this->view->registry->controller=='sites'){?>
                        <li><a href="/admin/sites/" class="sm4">Сайты</a></li>
                        <li><a href="/admin/sites/aplications/" class="sm4">Заявки</a></li>
                        <?}?>
						</ul>
				<!--	<ul>
