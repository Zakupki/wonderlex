...
var RLANG = {
  ...
  table: 'Table',
  link: 'Link',
  link_blank: 'Open link in a new window',
  ...
  deleted: 'Deleted',
  anchor: 'Anchor',
  image_remove_confirm: 'Do you really want to delete the image?',
  browse: 'Browse files...'
};
...
(function($){
    ...
    this.opts = $.extend({
      ...
      modal_file: String() + 
        '<form id="redactorUploadFileForm" method="post" action="" enctype="multipart/form-data">' +
          '<div class="field">' +
            '<div class="label"><label for="redactor_filename">Name (optional)</label></div>' +
            '<div class="input-text"><input type="text" id="redactor_filename" class="redactor_input" /></div>' +
          '</div>' +
          '<div class="field">' +
            '<div class="input-file"><div class="button-small button"><div class="bg"><div class="r"><div class="l"><div class="el">' + RLANG.browse + '<input id="redactor_file" name="file" type="file" /></div></div></div></div></div></div>' +
          '</div>' +
        '</form>',

      modal_image_edit: String() + 
        '<div class="field">' +
          '<div class="label"><label for="redactor_file_alt">' + RLANG.title + '</label></div>' +
          '<div class="input-text"><input id="redactor_file_alt" class="redactor_input" /></div>' +
        '</div>' +
        '<div class="field">' +
          '<div class="label"><label for="redactor_file_link">' + RLANG.link + '</label></div>' +
          '<div class="input-text"><input id="redactor_file_link" class="redactor_input" /></div>' +
        '</div>' +
        '<div class="field">' +
          '<div class="input-checkbox"><input id="redactor_file_link_blank" type="checkbox" /><label for="redactor_file_link_blank">' + RLANG.link_blank + '</label></div>' +
        '</div>' +
        '<div class="field">' +
          '<div class="label"><label for="redactor_form_image_align">' + RLANG.image_position + '</label></div>' +
          '<div class="select">' +
        ...
        '<div id="redactor_modal_footer">' +
          '<div class="redactor_btns_box">' +
            '<div class="button-remove button"><div class="bg"><div class="r"><div class="l"><button id="redactor_image_delete_btn" class="el" type="button">' + RLANG._delete + '</button></div></div></div></div>' +
            '<div class="button"><div class="bg"><div class="r"><div class="l"><button id="redactorSaveBtn" class="el" type="button">' + RLANG.save + '</button></div></div></div></div>' +
            '<div class="button"><div class="bg"><div class="r"><div class="l"><button id="redactor_btn_modal_close" class="el" type="button">' + RLANG.cancel + '</button></div></div></div></div>' +
          '</div>' +
        '</div>',
      ...
      modal_image: String() + 
        ...
        '<div id="redactor_tab3" class="redactor_tab" style="display: none;">' +
          '<div class="field">' +
            '<div class="label"><label for="redactor_file_link">' + RLANG.image_web_link + '</label></div>' +
            '<div class="input-text"><input name="redactor_file_link" id="redactor_file_link" class="redactor_input"  /></div>' +
          '</div>' +
        '</div>' +
        '<div id="redactor_modal_footer">' +
          '<div class="redactor_btns_box">' +
            '<div class="button"><div class="bg"><div class="r"><div class="l"><button id="redactor_upload_btn" class="el" type="button">' + RLANG.insert + '</button></div></div></div></div>' +
            '<div class="button"><div class="bg"><div class="r"><div class="l"><button id="redactor_btn_modal_close" class="el" type="button">' + RLANG.cancel + '</button></div></div></div></div>' +
          '</div>' +
        '</div>',
      ...
      modal_link: String() + 
        '<form id="redactorInsertLinkForm" method="post" action="">' +
          '<div id="redactor_tabs">' +
            ...
            '<a href="javascript:void(null);">E-mail</a>' +
            '<a href="javascript:void(null);">' + RLANG.anchor + '</a>' +
          '</div>' +
          '<input type="hidden" id="redactor_tab_selected" value="1" />' +
          '<div class="redactor_tab" id="redactor_tab1">' +
            '<div class="field">' +
              '<div class="label"><label for="redactor_link_url">URL</label></div>' +
              '<div class="input-text"><input id="redactor_link_url" class="redactor_input"  /></div>' +
            '</div>' +
            '<div class="field">' +
              '<div class="input-checkbox"><input id="redactor_link_url_blank" type="checkbox" /><label for="redactor_link_url_blank">' + RLANG.link_blank + '</label></div>' +
            '</div>' +
            '<div class="field">' +
              '<div class="label"><label for="redactor_link_url_text">' + RLANG.text + '</label></div>' +
              '<div class="input-text"><input id="redactor_link_url_text" class="redactor_input redactor_link_text" /></div>' +
            '</div>' +
          '</div>' +
          '<div class="redactor_tab" id="redactor_tab2" style="display: none;">' +
            '<div class="field">' +
              '<div class="label"><label for="redactor_link_mailto">Email</label></div>' +
              '<div class="input-text"><input id="redactor_link_mailto" class="redactor_input" /></div>' +
            '</div>' +
            '<div class="field">' +
              '<div class="label"><label for="redactor_link_mailto_text">' + RLANG.text + '</label></div>' +
              '<div class="input-text"><input id="redactor_link_mailto_text" class="redactor_input redactor_link_text" /></div>' +
            '</div>' +
          '</div>' +
          '<div class="redactor_tab" id="redactor_tab3" style="display: none;">' +
            '<div class="field">' +
              '<div class="label"><label for="redactor_link_anchor">' + RLANG.anchor + '</label></div>' +
              '<div class="input-text"><input id="redactor_link_anchor" class="redactor_input" /></div>' +
            '</div>' +
            '<div class="field">' +
              '<div class="label"><label for="redactor_link_anchor_text">' + RLANG.text + '</label></div>' +
              '<div class="input-text"><input id="redactor_link_anchor_text" class="redactor_input redactor_link_text" /></div>' +
            '</div>' +
          '</div>' +
        '</form>' +
        '<div id="redactor_modal_footer">' +
          '<div class="redactor_btns_box">' +
            '<div class="button"><div class="bg"><div class="r"><div class="l"><button id="redactor_insert_link_btn" class="el" type="button">' + RLANG.insert + '</button></div></div></div></div>' +
            '<div class="button"><div class="bg"><div class="r"><div class="l"><button id="redactor_btn_modal_close" class="el" type="button">' + RLANG.cancel + '</button></div></div></div></div>' +
          '</div>' +
        '</div>',
      ...
      modal_table: String() + 
          '<div class="field">' +
            '<div class="label"><label for="redactor_table_rows">' + RLANG.rows + '</label></div>' +
            '<input id="redactor_table_rows" size="5" value="2" />' +
          '</div>' +
          '<div class="field">' +
            '<div class="label"><label for="redactor_table_columns">' + RLANG.columns + '</label></div>' +
            '<input id="redactor_table_columns" size="5" value="3" />' +
          '</div>' +
          '<div id="redactor_modal_footer">' +
            '<div class="redactor_btns_box">' +
              '<div class="button"><div class="bg"><div class="r"><div class="l"><button id="redactor_insert_table_btn" class="el" type="button">' + RLANG.insert + '</button></div></div></div></div>' +
              '<div class="button"><div class="bg"><div class="r"><div class="l"><button id="redactor_btn_modal_close" class="el" type="button">' + RLANG.cancel + '</button></div></div></div></div>' +
            '</div>' +
          '</div>',
      ...
      modal_video: String() + 
        '<form id="redactorInsertVideoForm">' +
          '<div class="field">' +
            '<div class="label"><label for="redactor_insert_video_area">' + RLANG.video_html_code + '</label></div>' +
            '<div class="textarea"><textarea id="redactor_insert_video_area"></textarea></div>' +
          '</div>' +
        '</form>' +
        '<div id="redactor_modal_footer">' +
          '<div class="redactor_btns_box">' +
            '<div class="button"><div class="bg"><div class="r"><div class="l"><button id="redactor_insert_video_btn" class="el" type="button">' + RLANG.insert + '</button></div></div></div></div>' +
            '<div class="button"><div class="bg"><div class="r"><div class="l"><button id="redactor_btn_modal_close" class="el" type="button">' + RLANG.cancel + '</button></div></div></div></div>' +
          '</div>' +
        '</div>',
  ...
  Redactor.prototype = {
    ...
    setDoc: function(html)
    {
      ...
      '<html xmlns="http://www.w3.org/1999/xhtml"><head><link href="' + this.opts.css + '" type="text/css" rel="stylesheet" /></head>' +
    ...
    resizeImage: function(resize)
    {
      ...
      $(resize).hover(function() { $editor.css('cursor', 'nw-resize'); }, function() { $editor.css('cursor',''); clicked=false; });
    ...
    showTable: function()
    {
      this.modalInit(RLANG.table, 'table', 600, $.proxy(function()
        {        
    ...
    imageEdit: function(e)
    {
      ...
      var handler = $.proxy(function()
      {
        ...
        if ($(parent).get(0).tagName === 'A')
        {
          ...
          $('#redactor_file_link_blank').prop('checked', $(parent).attr('target') == '_blank');
        }
      ...
      this.modalInit(RLANG.image, 'image_edit', 600,  handler);
    ...
    imageSave: function(el)
    {
      ...
      var link = $.trim($('#redactor_file_link').val()),
          blank = $('#redactor_file_link_blank').prop('checked');
      if (link !== '')
      {
        if ($(parent).get(0).tagName !== 'A')
        {
          $(el).replaceWith('<a href="' + link + '"' + (blank ? ' target="_blank"' : '') + '>' + this.outerHTML(el) + '</a>');
        }
        else
        {
          $(parent).attr('href', link).attr('target', (blank ? '_blank' : ''));
        }
      }
      else
      {
    ...
    showImage: function()
    {
      ...
      var handler = $.proxy(function()
      {
        ...
        if (this.opts.imageGetJson !== false)
        {
          $.getJSON(this.opts.imageGetJson, $.proxy(function(data) {
            ...
            {
              var $item = $('<div class="li"><img src="' + val.thumb + '" rel="' + val.image + '" /><i class="remove"></i><input name="id[' + key + ']" value="' + val.id + '" type="hidden" /></div>');
              $('#redactor_image_box').append($item);
              $('img', $item).click($.proxy(this.imageSetThumb, this));
              $('.remove', $item).click($.proxy(this.imageRemove, this));
            }, this));
      ...
      this.modalInit(RLANG.image, 'image', 600, handler, endCallback, true);
    ...
    imageRemove: function(e)
    {
        var $item = $(e.target).closest('.li'),
            ...
            src = $img.attr('rel'),
            URL = this.opts.imageRemove;
        $.confirm({
            text: RLANG.image_remove_confirm,
            ok: function(){
                $.popup.showLoading();
    ...
    _imageSet: function(json, link)
    {
     ...
     function resize(img) {
         ...
         if (img.width > max_w) {
             ...
             img.style.height = max_w / (width / height) + 'px';
         }
     }
    ...
    showLink: function()
    {
      var handler = $.proxy(function()
      {
        ...
        if ($.browser.msie)
        {
          ...
          if (parent.nodeName === 'A')
          {
            ...
            blank = this.insert_link_node.attr('target') == '_blank';
        ...
        {          
          if (sel && sel.anchorNode && sel.anchorNode.parentNode.tagName === 'A')
          {
            ...
            blank = sel.anchorNode.parentNode.target == '_blank';
        ...
        else
        {
          ...
          $('#redactor_link_url_blank').prop('checked', blank);
        }
      ...
      this.modalInit(RLANG.link, 'link', 600, handler, endCallback);

    },
    insertLink: function()
    {
      var tab_selected = $('#redactor_tab_selected').val();
      var link = '', blank = false, text = '';
      
      if (tab_selected === '1') // url
      {
        link = $('#redactor_link_url').val();
        blank = $('#redactor_link_url_blank').prop('checked');
      ...
      this._insertLink('<a href="' + link + '"' + (blank ? ' target="_blank"' : '') + '>' +  text + '</a> ', $.trim(text), link, blank);

    },
    _insertLink: function(a, text, link, blank)
    {
      if (text != '')
      {
        if (this.insert_link_node)
        {
          ...
          $(this.insert_link_node).attr('target', blank ? '_blank' : '');
          this.syncCode();
        }
        else
        {
    ...
    showFile: function()
    {
      ...
      this.modalInit(RLANG.file, 'file', 600, handler);
    },
    ...
    modalInit: function(title, url, width, handler, endCallback, scroll)
    {
        ...
        $('#redactor_tabs a').each(function(i,s)
        {
          ...
          $(s).click(function()
          {
            ...
            if (that.isMobile() === false)
            {
              ...
              $('#redactor_modal').css('margin-top', '-' + height/2 + 'px');
            }
          });
        });
      }
      ...
      if (this.isMobile() === false)
      {
        $('#redactor_modal').css({ position: 'fixed', top: '50%', left: '50%', width: width + 'px', height: 'auto', marginTop: '-' + height/2 + 'px', marginLeft: '-' + width/2 + 'px' }).fadeIn(100);
      }
      else
      {
      ...
      $('#redactor_modal select').jselect();
      $('#redactor_modal .input-checkbox').jcheckbox();
    ...
    modalClose: function()
    {
      ...
      $('#redactor_modal').fadeOut(100, $.proxy(function()
      {
  ...
  Construct.prototype = {
    ...
    {  
      ...
      {  
        ...
        this.dropalternative = $('<div class="redactor_dropalternative label"><label for="redactor_file">' + this.opts.atext + '</label></div>');
        
        this.droparea.append(this.dropareabox);
        
        this.$el.closest('.field').before(this.droparea);
        this.$el.closest('.field').prepend(this.dropalternative);
