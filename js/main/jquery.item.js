...
function Item() {
    ...
    this.likeButtonClick = function() {
        ...
        if (element.hasClass('btn_without-auth')) {
    ...
    this.checkAuthorization = function(event) {
        var element = $(this);
    ...
    this.addEventList = function() {
        ...
        ctrl.buttons.on('click', Self.checkAuthorization);
    ...
    this.getControls = function() {
        ...
        ctrl.buttons = $('.item__view-price-buttons .btn');
    };
