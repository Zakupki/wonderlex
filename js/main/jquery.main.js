...
var Wonderlex = {
    ...
    controls: function() {
        ...
        authorsListSortParameters.find('li').on('click', function() {
            ...
            var authorsListForm = $('#authors-list'),
                catalog = $('.catalog');

            if (authorsListForm.length) {
            ...
            if (catalog.length) {
                catalogFilter.chengeGallery(dataToSend);
            }

            authorsListSortWrap.click();
    ...
    Wonderlex.Authorization.prototype = {
            ...
            body
                ...
                .on( 'submit', '.login', function(){
                    ...
                    function showErr( text ) {
                        $( ".err-message" ).remove();
                        var errMsg = $( '<div class="err-message">' + decodeURIComponent(text) + '</div>' );
                        $( '.login' ).append( errMsg );
                    }
                } );
        ...
        showgoodMessage: function( txt ){
            var self = this,
                login = $( '.login'),
                curElems = login.find( '> *'),
                goodText = $( '<div class="good-text">' + decodeURIComponent(txt) + '</div>'),
